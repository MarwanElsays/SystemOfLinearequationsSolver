...
public class LinearFrame extends JFrame {
    ...
    private LinearFrame frame = this;
    ...
    ActionListener buttonListener = new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            new LinearInputHandler(frame).solve();
        }
    };
    ...
    ActionListener methodListener = new ActionListener() {
        ...
        @Override
        public void actionPerformed(ActionEvent e) {
            new LinearInputHandler(frame).setMethod();
        }
    };
    ...
    MouseListener buttonMouseListener = new MouseListener(){
        ...
        public void mouseEntered(MouseEvent e) {
            new LinearInputHandler(frame).ChangeColor(new Color(0xFF8C00));
        }

        @Override
        public void mouseExited(MouseEvent e) {
            new LinearInputHandler(frame).ChangeColor(Color.ORANGE);
        }
